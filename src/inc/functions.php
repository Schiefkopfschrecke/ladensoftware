 ...
 * - in den Klammern die Parameter (oder Argumente)
 * - zwingende Parameter erhalten keinen Standardwert und müssen angegeben werden
 * - optionale Parameter erhalten einen Standartwert
 **/

include '../config/Secrets.php';

function mail_senden_smtp($an, $von, $betreff, $mail_inhalt)
{
	// Mail verschicken
