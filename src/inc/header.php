...
<body>
	<div id="seite">
		<nav>
			<ul>
				<li><a href="index.php" title="Startseite" alt=""><img src="design/logo_gemeinsaftladen_klein.png" height="70px"></li>
				<li><a href="einkaufen.php" title="Einkaufen" alt="">Einkaufen</a></li>
				<li><a href="mitgliedschaft.php" title="Mitglied werden" alt="">Mitgliedschaft</a></li>
				<li><a href="sortiment.php" title="Sortiment" alt="">Sortiment</a></li>
				<?php
				$mitgliederdaten = 0;

				if (isset($_SESSION['user']['id'])) {
					echo '<li><a href="meine_boerse.php" title="Leihbörse" alt="">Leihen</a></li>';
					echo '<li><a href="logout.php" title="Logout" alt="">Logout</a></li>';
