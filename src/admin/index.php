...
if ($benutzername) {
	...
	$res = db_anfragen('SELECT id, vorname, name, email, benutzername, letzte_anmeldung, ist_admin, ist_angemeldet FROM mitglieder WHERE benutzername = "' . $benutzername . '" AND passwort = "' . $pw . '" LIMIT 1');
